...
// --- Per-step schemas for draft persistence ---

export const acquisitionStep1Schema = z.object({
  title: z.string().min(5, 'O título deve ter pelo menos 5 caracteres'),
  property_type: z.string().min(1, 'Seleccione o tipo de imóvel'),
  business_type: z.string().min(1, 'Seleccione o tipo de negócio'),
  listing_price: z.number().positive('O preço deve ser positivo'),
...
export const acquisitionStep2Schema = z.object({
  address_street: z.string().min(1, 'A morada é obrigatória'),
  city: z.string().min(1, 'A cidade é obrigatória'),
  address_parish: z.string().optional(),
  postal_code: z.string().optional(),
...
export const acquisitionStep3Schema = z.object({
  owners: z.array(ownerSchema).min(1, 'Deve ter pelo menos um proprietário'),
})

export const acquisitionStep4Schema = z.object({
  contract_regime: z.string().min(1, 'Seleccione o regime de contrato'),
...
export const acquisitionStep5Schema = z.object({
  documents: z
    .array(
      z.object({
        doc_type_id: z.string(),
...
export const stepSchemas = {
  1: acquisitionStep1Schema,
  2: acquisitionStep2Schema,
  3: acquisitionStep3Schema,
  4: acquisitionStep4Schema,
  5: acquisitionStep5Schema,
} as const
...
export type AcquisitionStep1Data = z.infer<typeof acquisitionStep1Schema>
export type AcquisitionStep2Data = z.infer<typeof acquisitionStep2Schema>
export type AcquisitionStep3Data = z.infer<typeof acquisitionStep3Schema>
export type AcquisitionStep4Data = z.infer<typeof acquisitionStep4Schema>
export type AcquisitionStep5Data = z.infer<typeof acquisitionStep5Schema>
