...
export default function EditarImovelPage() {
  ...
  const defaultValues = {
    ...
    area_gross_private: (specs as { area_gross_private?: number | null } | null)?.area_gross_private ?? '',
    area_util: specs?.area_util ?? '',
    area_total_lot: (specs as { area_total_lot?: number | null } | null)?.area_total_lot ?? '',
