...
export const ACTIVITY_TYPE_LABELS: Record<ActivityType, string> = {
  ...
  temperature_change: 'Mudanca de Temperatura',
  referral_inherited: 'Referencia herdada',
...
export const ACTIVITY_TYPE_COLORS: Record<ActivityType, string> = {
  ...
  temperature_change: 'text-rose-600',
  referral_inherited: 'text-sky-600',
