...
import { CATEGORY_ICON_PRESETS } from '@/components/documents/company-category-icons'
...
interface MarketingDesignCategoryFormDialogProps {
  open: boolean
...
export function MarketingDesignCategoryFormDialog({
  open,
  onOpenChange,
  category,
  onSaved,
}: MarketingDesignCategoryFormDialogProps) {
  const { create, update } = useMarketingDesignCategoriesContext()
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      let result: MarketingDesignCategory
