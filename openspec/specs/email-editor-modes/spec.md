...
Defines the three top-level modes of the email template editor
(`/dashboard/templates-email/*`) and the behaviour that guarantees
round-trip safety of content between them.
