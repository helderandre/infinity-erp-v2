...
- [ ] 5.1 Testar geração com diferentes instruções e verificar que as mensagens são válidas
- [ ] 5.2 Testar formatação WhatsApp (*bold*, _italic_, emojis) no preview
- [ ] 5.3 Testar delays entre mensagens no preview
- [ ] 5.4 Garantir que toda a UI está em PT-PT
